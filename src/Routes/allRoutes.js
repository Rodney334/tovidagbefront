...
import Aadashboard from "../pages/Aadashboard";
...
import Aaacueil from "../pages/Aaacueil";
import Aadetails from "../pages/Aadetails";
import Aafollow from "../pages/Aafollow";
import AalistCours from "../pages/AalistCours";
...
const authProtectedRoutes = [
  ...
  {
    path: "/dashboard", component: <Aadashboard /> 
  },
  {
      path: "/users", component: <Aausers/> ,
  },
  {
      path: "/complaints/new", component: <Aaplaintes /> ,
  },
  {
      path: "/complaints/in-progress", component: <AaplaintesProcess /> ,
  },
  {
