...
import { CardBody, Row, Col, Card, CardHeader, Container, Button, Modal, ModalHeader, ModalBody, FormGroup, Label, Input, FormFeedback, ModalFooter } from "reactstrap";
...
const ComplaintDetails = (props) => {
  ...
  const handleAccept = async() => {
    ...
    try {
      ...
      if(response){
        toast.success("Plainte Acceptée.")
        setTimeout(() => {
          props.router.navigate("/complaints/new")
        }, 3500);
      }
    } catch (error) {
      alert("Echec")
