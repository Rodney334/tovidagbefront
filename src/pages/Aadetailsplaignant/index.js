                  ...
                  <CardHeader className="border-bottom-dashed p-4">
                    <div className="d-flex">
                      ...
                      <div className="flex-shrink-0 mt-sm-0 mt-3">
                        <h6>
                          <span className="text-muted fw-normal">Nom:</span> {complaintData.name}
                        </h6>
                      </div>
                    </div>
                  </CardHeader>
                  ...
                  <CardBody className="p-4">
                    <Row className="g-3">
                      <Col lg={6}>
                        ...
                        <h5 className="fs-14 mb-0">{complaintData.name}</h5>
                      </Col>
                      <Col lg={6}>
                        <p className="text-muted mb-2 text-uppercase fw-semibold">
                          Age
                        </p>
                        <h5 className="fs-14 mb-0">{complaintData.age}</h5>
                      </Col>
                      <Col lg={6}>
                        <p className="text-muted mb-2 text-uppercase fw-semibold">
                          Fonction
                        </p>
                        <h5 className="fs-14 mb-0">{complaintData.fonction}</h5>
                      </Col>
                      <Col lg={6}>
                        <p className="text-muted mb-2 text-uppercase fw-semibold">
                          Sexe
                        </p>
                        <h5 className="fs-14 mb-0">{complaintData.sexe}</h5>
                      </Col>
                      <Col lg={6}>
                        <p className="text-muted mb-2 text-uppercase fw-semibold">
                          Commune
                        </p>
                        <h5 className="fs-14 mb-0">{complaintData.commune}</h5>
                      </Col>
                      <Col lg={6}>
                        <p className="text-muted mb-2 text-uppercase fw-semibold">
                          Arrondissement
                        </p>
                        <h5 className="fs-14 mb-0">{complaintData.arrondissement}</h5>
                      </Col>
                      <Col lg={6}>
                        <p className="text-muted mb-2 text-uppercase fw-semibold">
                          Téléphone
                      ...
                      <Col lg={6}>
                        ...
                        <h5 className="fs-14 mb-0">{complaintData.handicap}</h5>
                      </Col>
                      <Col lg={12}>
                        <p className="text-muted mb-2 text-uppercase fw-semibold">
                          Description
